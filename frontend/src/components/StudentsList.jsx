...
import student_male from '../../public/img/student_male.jpg'
import student_female from '../../public/img/student_female.jpg'
import {
  Card,
  CardHeader,
  CardBody,
...
function StudentList() {
  ...
  const [alert, setAlert] = useState(updateParam);
            ...
            <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
              ...
              <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
                <table className="w-full min-w-[640px] table-auto">
                  ...
                  <tbody>
                    {students.map(
                ({ id, name, email, major, student_year, phone,gender, suspended }) => {
                  const className = `py-3 px-5 ${
                    ...
                    <tr key={id}>
                      <td className={className}>
                        ...
                        {gender === 'male' ? (
  <Avatar src={student_male} size="sm" alt="male" variant="rounded" />
) : (
  <Avatar src={student_female} size="sm" alt="female" variant="rounded" />
)}
