...
<div className="w-72 mt-5">
  Status : {studentData.suspended === 0 ? (
      <span className="inline-block px-16 py-3 text-sm ms-4 font-medium text-green-900 bg-green-100 rounded-full">Active</span>
    ) : (
      <span className="inline-block px-16 py-3 text-sm ms-4 font-medium text-red-900 bg-red-100 rounded-full">Suspended</span>
    )}
</div>  
<div className="w-72 mt-5">
