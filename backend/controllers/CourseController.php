...
class CourseController
{
    ...
    public function create_course()
    {
        ...
        $requiredFileds = ['course_code', 'course_name', 'course_year', 'semester', 'major'];
        $missingFields = [];
        ...
        try {
            $query = "INSERT INTO courses (course_name, course_code, course_year, semester, major ) VALUES (:course_name, :course_code, :course_year, :semester, :major)";
            $stmt = $this->conn->prepare($query);
    ...
    public function update_course($id)
    {
        ...
        try {
            $query = "UPDATE courses SET course_code = :course_code ,course_name = :course_name, course_year =:course_year, semester=:semester , major=:major, updated_date = NOW() WHERE id = :id";
            $stmt = $this->conn->prepare($query);
